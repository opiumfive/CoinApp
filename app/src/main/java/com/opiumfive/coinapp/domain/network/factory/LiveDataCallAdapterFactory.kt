package com.opiumfive.coinapp.domain.network.factory
...
import com.opiumfive.coinapp.domain.network.adapter.LiveDataCallAdapter
...
class LiveDataCallAdapterFactory : Factory() {
    override fun get(returnType: Type, annotations: Array<Annotation>, retrofit: Retrofit): CallAdapter<*, *>? {
        if (Factory.getRawType(returnType) != LiveData::class.java) {
            throw IllegalArgumentException("type must be a LiveData")
        }
